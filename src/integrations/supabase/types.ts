...
export type CourseRow = {
  id: string; slug: string; title: string; level: CourseLevel; description: string;
  objectives: any[]; methodology: string | null; expected_results: string | null;
...
export type LeadRow = {
  ...
  city: string; state: string; observations: string | null;
  terms_accepted: boolean; recording_authorized: boolean | null;
  status: LeadStatus; source: string | null; user_agent: string | null; ip_address: string | null;
  created_at: string; updated_at: string;
};
